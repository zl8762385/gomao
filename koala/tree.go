...
func (n *node) addRoute(path string, handle HandlerRouter) {
	fullPath := path
	n.priority++
...
func (n *node) insertChild(numParams uint8, path, fullPath string, handle HandlerRouter) {
...
// given path.
func (n *node) getValue(path string) (handle HandlerRouter, p Params, tsr bool) {
